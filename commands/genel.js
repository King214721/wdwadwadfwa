...
exports.conf = {
  ...
  aliases: ["genel"], //kısayollar
  permLevel: 0 //perm level mainde karşıliklar yazar
};
  
exports.help = {
 name: "genel", //komutu çalıştıracak olan kelime
